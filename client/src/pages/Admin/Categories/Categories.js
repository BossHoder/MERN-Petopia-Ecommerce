...
const Categories = () => {
    ...
    useEffect(() => {
        dispatch(getAdminCategories(currentPage, limit, searchTerm, sortBy, sortOrder));
    ...
    const columns = [
        {
            key: 'name',
            title: t('admin.categories.name', 'Name'),
            width: '20%',
            render: (value, item) => (
        ...
        {
            key: 'description',
            title: t('admin.categories.description', 'Description'),
            width: '25%',
            render: (value) => (
        ...
        {
            key: 'isPublished',
            title: t('admin.categories.status', 'Status'),
            width: '10%',
            align: 'center',
            render: (value) => (
        ...
        {
            key: 'actions',
            title: t('admin.categories.actions', 'Actions'),
            width: '5%',
            align: 'center',
            render: (_, item) => (
    ...
    const confirmDelete = async () => {
        try {
            if (selectedItems.length === 1) {
                await dispatch(deleteCategory(selectedItems[0]));
            } else {
                await dispatch(bulkDeleteCategories(selectedItems));
            }
            setSelectedItems([]);
        ...
        <div className="admin-categories">
            ...
            <div className="admin-page-header">
                <div className="admin-page-title">
                    <h1>{t('admin.categories.title', 'Categories Management')}</h1>
                    <p className="admin-page-subtitle">
                        {t('admin.categories.subtitle', 'Manage your product categories')}
                    </p>
                </div>
            </div>
                ...
                <div className="admin-modal-overlay">
                    <div className="admin-modal">
                        <div className="admin-modal-header">
                            <h3>{t('admin.categories.deleteConfirm', 'Confirm Delete')}</h3>
                        </div>
