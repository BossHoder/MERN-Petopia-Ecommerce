...
export const createCouponSchema = Joi.object({
    ...
    excludeCategories: Joi.array()
        .items(Joi.string().trim())
        .optional(),

    excludeProducts: Joi.array()
        .items(Joi.string().trim())
        .optional(),
...
export const couponQuerySchema = Joi.object({
    ...
    sort: Joi.string().valid('code', 'discountValue', 'validFrom', 'validUntil', 'usageCount', 'createdAt').default('createdAt'),
